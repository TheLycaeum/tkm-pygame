...
import pygame
from pygame.locals import DOUBLEBUF, KEYDOWN, K_ESCAPE, FULLSCREEN
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, fighter, group, fire_group):
        ...
        self.image = pygame.image.load("enemy-small.png").convert_alpha()
        self.rect = self.image.get_rect()
        self.rect.center = (x,y)
        self.add(group)
...
fighter = Ship(320, 240, all_sprites) # Create a ship
Enemy(200, 240, fighter, all_sprites, [all_sprites, enemy_fire]) # Create an enemy ship (pass the fighter to it)
